...
const Model = ({ children, isOpen, onClose, title }) => {
    if (!isOpen) return
    return (
        <div className="flex top-0 left-0 right-0 z-50 justify-center items-center h-[calc(100%-1rem)] max-h-full overflow-y-auto overflow-x-hidden bg-opacity-50">
            {/* Modal wrapper */}
            <div className="relative w-full max-w-2xl max-h-full p-4">
                {/* Modal content */}
                <div className="ralative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                    {/* Modal header */}
